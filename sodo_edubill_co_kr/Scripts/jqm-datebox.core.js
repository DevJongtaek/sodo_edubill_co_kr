 ...
 * Date: Fri Dec 5 2014 22:45:41 UTC
	...
	$.widget( "mobile.datebox", {
		...
		open: function () {
			...
			w.d.mainWrap
				...
				.popup( basepop )
				.popup( "open", popopts );
			//$('.ui-popup-container').addClass('ui-alt-icon');
			$('.ui-popup-container').attr('style', 'width:100%;height:100%;')
			$('.ui-datebox-container').attr('style', 'z-index:1100;margin:0 auto;top:50%;margin-top:-50%;')
		},
		close: function() {
